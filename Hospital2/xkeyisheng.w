...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
   <div class="x-panel-top" xid="top1"><div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1" title="X科医生" style="background-color:#60cfed;">
   ...
   <div class="x-titlebar-title" xid="title1">X科医生</div>
   ...
   <div class="x-panel-content  x-scroll-view" xid="content1" _xid="C783BD6F0560000162A9F7D0153016C5" style="bottom: 0px;"><div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView" xid="scrollView1">
   <div class="x-content-center x-pull-down container" xid="div1">
    <i class="x-pull-down-img glyphicon x-icon-pull-down" xid="i1"></i>
    <span class="x-pull-down-label" xid="span1">下拉刷新...</span></div> 
   <div class="x-scroll-content" xid="div2"><div class="x-scroll-content" xid="div4">
     ...
     <div class="x-col" xid="col22">
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row7">
       ...
       <div class="x-col" xid="col18">
        <span xid="span19" style="font-size:10px;color:#808080;" class="pull-right">4578</span>
     ...
     <div class="x-col" xid="col12">
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3">
       <div class="x-col" xid="col9" style="font-weight:bold;">
        <span xid="span3" style="font-size:12px;">魏巍  口腔科 | 沈阳军区总医院</span></div> 
       <div class="x-col" xid="col7">
        <span xid="span5" style="font-size:10px;color:#808080;" class="pull-right">6278</span>
        <img alt="" xid="image1" class="pull-right" src="$UI/Hospital2/img/doctor/02-2-1.png"></img></div> </div> 
     ...
     <div class="x-col" xid="col13">
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row11">
       ...
       <div class="x-col" xid="col17">
        <span xid="span6" style="font-size:10px;color:#808080;" class="pull-right">4563</span>
        <img alt="" xid="image2" class="pull-right" src="$UI/Hospital2/img/doctor/02-2-1.png"></img></div> </div> 
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row13">
       <div class="x-col" xid="col15" style="font-size:10px;">
        <span xid="span13" style="width:100%;font-size:10px;">擅长：在三甲医院从事神经内科临床工作20余年，在脑血管疾病及神经系统计征等方面积累了丰富的临床工作经验。擅长：头痛、头晕、脑血管病</span></div> </div> </div> </div> </li> </div></div>
   </div></div>
   </div></div>