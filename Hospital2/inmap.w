...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
   <div class="x-panel-top" xid="top1">
    <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1" title="内部导航" style="background-color:#60cfed;">
     ...
     <div class="x-titlebar-title" xid="title1">内部导航</div>
   ...
   <div class="x-panel-content" xid="content1">
    <img src="$UI/Hospital2/img/hospitalm/01-3.jpg" alt="" xid="image1"></img></div> </div></div>