...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="top:23px;left:127px;height:auto;"/> 
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel2">
   <div class="x-panel-top" xid="top1" height="100">
    <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1" title="我的预约 " style="background-color:#60cfed;">
   ...
   <span xid="span11"></span></a></div>
     <div class="x-titlebar-title" xid="title1">我的预约 </div>
      ...
      <div class="x-col" xid="col6">
       <div component="$UI/system/components/justep/button/buttonGroup" class="btn-group x-card btn-group-justified" tabbed="true" xid="buttonGroup1" style="background-color:transparent;">
        ...
        <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="已完成" xid="button4" target="complete">
         <i xid="i6"></i>
         <span xid="span7">已完成</span></a> </div> </div> </div> </div> </div> 
       ...
       <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2" bind-click="openPageClick" pagename="./guideinformation.w">
        ...
        <div class="x-col" xid="col2">
         ...
         <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4">
          ...
          <div class="x-col pull-right" xid="col9">
           <a component="$UI/system/components/justep/button/button" class="btn btn-default pull-right" label="完成" xid="button1" style="background-color:#60cfed;">
            <i xid="i1"></i>
            <span xid="span6">完成</span></a> </div> </div> </div> </div> </li> </div> 
     <div class="x-contents-content" xid="complete">
      <div xid="div1" style="background-color:#D5D6CD;height:2%;"></div>
      <li xid="li2" bind-click="openPageClick" pagename="./guideinformation.w">
       <div component="$UI/system/components/justep/row/row" class="x-row" xid="row8">
        <div class="x-col x-col-fixed" xid="col23" style="width:auto;">
         <img src="$UI/Hospital2/img/guide/01-1.png" alt="" xid="image2" style="width:72px;height:76px;"></img></div> 
         ...
         <div component="$UI/system/components/justep/row/row" class="x-row" xid="row9">
          ...
          <div class="x-col pull-right" xid="col20">
           <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="button" xid="button2">
            <i xid="i2"></i>
            <span xid="span10"></span></a> </div> </div> </div> </div> </li> </div> </div> </div> </div></div>