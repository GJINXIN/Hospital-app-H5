...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="top:-2px;left:144px;height:auto;"/> 
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
   <div class="x-panel-top" xid="top1"><div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1" title="在线预约" style="background-color:#60cfed;">
   ...
   <div class="x-titlebar-title" xid="title1">在线预约</div>
   ...
   <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3" style="height:59px;">
    <div class="x-col" xid="col7">
     <div component="$UI/system/components/justep/button/buttonGroup" class="btn-group x-card btn-group-justified" tabbed="true" xid="buttonGroup1" style="background-color:transparent;height:39px;">
      <a component="$UI/system/components/justep/button/button" class="btn btn-default" xid="button3" target="content3" label="专家挂号" style="height:38px;font-size:16px;">
       <i xid="i3"></i>
       <span xid="span3">专家挂号</span></a> 
      <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="普通挂号" xid="button4" target="content4" style="font-size:16px;">
       <i xid="i6"></i>
       <span xid="span7">普通挂号</span></a> </div> </div> </div> </div></div>
   <div class="x-panel-content" xid="content2" _xid="C783B62F206000011B1FE54215201C12" style="bottom: 0px;"><div component="$UI/system/components/justep/contents/contents" class="x-contents x-full" active="0" xid="contents1">
   <div class="x-contents-content" xid="content3"><div xid="div2" bind-click="openPageClick" pagename="./keshizhuanjia.w">
  ...
  <div class="x-contents-content" xid="content4"><div xid="div1" bind-click="openPageClick" pagename="./putongguahao.w">
