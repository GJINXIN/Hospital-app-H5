...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
   <div class="x-panel-top" xid="top1"><div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1" title="X科专家 " style="background-color:#60cfed;">
   ...
   <div class="x-titlebar-title" xid="title1">X科专家 </div>
   ...
   <div class="x-panel-content  x-scroll-view" xid="content1" _xid="C783B7FCBFF000014934594014201E63" style="bottom: 0px;"><div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView" xid="scrollView1">
   <div class="x-content-center x-pull-down container" xid="div1">
    <i class="x-pull-down-img glyphicon x-icon-pull-down" xid="i1"></i>
    <span class="x-pull-down-label" xid="span1">下拉刷新...</span></div> 
   <div class="x-scroll-content" xid="div2"><li xid="li2" bind-click="openPageClick" pagename="./zhuanjiayuyue.w">
    ...
    <div class="x-col" xid="col22">
     <div component="$UI/system/components/justep/row/row" class="x-row" xid="row7">
      ...
      <div class="x-col" xid="col18">
       <span xid="span19" style="font-size:10px;color:#808080;" class="pull-right"><![CDATA[4578]]></span>
    ...
    <div class="x-col" xid="col12">
     <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3">
      ...
      <div class="x-col" xid="col7">
       <span xid="span5" style="font-size:10px;color:#808080;" class="pull-right"><![CDATA[6278]]></span>
